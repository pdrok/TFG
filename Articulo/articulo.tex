...
Rendimiento obtenido con metricas de Carga general del enlace. 

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.5\textwidth]{./figura001-1.png}
\caption{Prueba de tasa de traferencia de los enlaces}
...
\end{center}
\end{figure}
\textbf{En Negro}: las puertas de enlaces que estan activas.\\
\textbf{En Azul}: las puertas de enlaces que estan inactivas activas.

\subsection{Ping}
Ping desde la maquina de la sucursal a los demas equipos. 

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.5\textwidth]{./figura003-1.png}
\caption{Ping desde la maquina al router de la sucursal}
\label{ping-enlace}
\end{center}
\end{figure}
Prueba de estabilidad de ping a al entuteador que realiza el enlace.
...
\end{center}
\end{figure}
Con el radio enlace habilitado, la comunicacion de los equipos se realiza por tunel primario.
\begin{figure}[H]
\begin{center}
...
\end{center}
\end{figure}
Con el radio enlace inahabilitado, la comunicacion de los equipos se realiza por tunel secudario configurado sobre el Internet.
\section{Discusión.}
