...
\section{Winbox.}
Winbox es un programa ejecutable en Windows, en Linux y Mac OSX por medio de WINE, que me permite acceder a las múltiples configuraciones de mi mainboard desde mi PC por medio de un entorno amigable. Es un software liviano que se lo puede descargar de la página Mikrotik\cite{winbox:down} 
\begin{figure}[H]
\begin{center}
