...
\chapter{Conceptos Fundamentales y Antecedente }
...
Entre los términos de seguridad dentro del ámbito de las \Gls{tics}, se pueden definir los siguientes:\\
\begin{itemize}
...
Desde el inicio de las telecomunicaciones, cuando una información es transmitida por un canal de comunicación está sometida a riesgos porque existen amenazas y el canal de comunicación tiene vulnerabilidades (un canal de comunicación es, en la mayoría de los casos, esencialmente inseguro e inestable).\cite{seguridad:2004}\\
...
\caption{Enlace Punto Multipunto \cite{wireless:desarrollo}}
...
\caption{Conexión Malla \cite{wireless:desarrollo}}
